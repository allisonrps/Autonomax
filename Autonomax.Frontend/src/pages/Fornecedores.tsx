        ...
        {fornecedorEdicao && (
          <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
            <div className="bg-gray-900 p-6 rounded-xl border border-gray-800 w-full max-w-md space-y-4">
              ...
              <input className="w-full p-3 bg-gray-950 border border-gray-800 rounded-md text-sm" value={fornecedorEdicao.nome} onChange={e => setFornecedorEdicao({...fornecedorEdicao, nome: e.target.value})} placeholder="Nome" />
              <input className="w-full p-3 bg-gray-950 border border-gray-800 rounded-md text-sm" value={fornecedorEdicao.telefone} onChange={e => setFornecedorEdicao({...fornecedorEdicao, telefone: e.target.value})} placeholder="Telefone" />
              <input className="w-full p-3 bg-gray-950 border border-gray-800 rounded-md text-sm" value={fornecedorEdicao.categoria} onChange={e => setFornecedorEdicao({...fornecedorEdicao, categoria: e.target.value})} placeholder="Categoria" />
